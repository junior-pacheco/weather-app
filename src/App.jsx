...
const App = () => {
  ...
  const handleInputChange = (e) => {
    ...
    // Si se borra el valor del input, limpiamos la información de weatherData
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-2">
      ...
      <div className="flex flex-col md:flex-row justify-between bg-black shadow-xl p-2 rounded-xl w-full">
        <div className='flex justify-center items-center gap-2 ps-2 h-full'>
          ...
          <h1 className="text-3xl font-bold mb-4 text-white">Weather App</h1>
        </div>
        <div className='flex gap-5 justify-end w-full md:w-[50%]'>
          <input 
            type="text" 
            value={inputValue} 
          ...
          <button 
            ...
            className="p-2 bg-green-500 w-[100px] text-white rounded"
          >
            Search
          </button>
        </div>
